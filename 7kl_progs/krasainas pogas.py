...
btn1=Button(logs,text='Red', fg='#000000',bg='#ff0000',font=('Arial',16),width=14)
btn1.grid(row=2,column=0,padx=20, pady=10)
btn2=Button(logs,text='Orange', fg='#000000',bg='#00a500',font=('Arial',16),width=14)
btn2.grid(row=2,column=1,pady=10)
btn3=Button(logs,text='Yellow', fg='#000000',bg='#ffff00',font=('Arial',16),width=14)
btn3.grid(row=2,column=2,pady=10)
btn4=Button(logs,text='Green', fg='#000000',bg='#008000',font=('Arial',16),width=14)
btn4.grid(row=3,column=0,pady=10)
btn5=Button(logs,text='Blue', fg='#000000',bg='#0000ff',font=('Arial',16),width=14)
btn5.grid(row=3,column=1,pady=10)
btn6=Button(logs,text='Indigo', fg='#ffaa00',bg='#4b0082',font=('Arial',16),width=14)
btn6.grid(row=3,column=2,pady=10)
btn7=Button(logs,text='Violet', fg='#000000',bg='#ee82ee',font=('Arial',16),width=14)
